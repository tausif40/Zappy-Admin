	...
	return (
		<>
			...
			>
				...
				{/* Navigation */}
				<ScrollArea className="h-screen mb-14">
				...
				{/* User Menu */}
				<div className="absolute bottom-0 right-0 z-10 py-2 px-4 w-full border-t border-gray-200 dark:border-gray-700">
					<DropdownMenu>
						<DropdownMenuTrigger asChild>
							<Button variant="secondary" className={cn("w-full justify-start", isCollapsed && "justify-center")}>
						...
						<DropdownMenuContent align="end" className="w-56">
							...
							<DropdownMenuItem onClick={handleLogout} className="py-2 bg-red-100 hover:!bg-red-200 dark:bg-red-800/30 dark:hover:!bg-red-800/40 mt-1 cursor-pointer">
