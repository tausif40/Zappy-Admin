...
import { statsColors } from "@/lib/colorPresets"
				...
				<CardContent>
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
						<Link href="/admin/events">
							<Button className="w-full h-20 flex flex-col space-y-2 bg-blue-100 text-blue-700 hover:bg-blue-200">
						...
						<Link href="/admin/categories">
							<Button className="w-full h-20 flex flex-col space-y-2 bg-green-100 text-green-700 hover:bg-green-200">
						...
						<Link href="/admin/verification">
							<Button className="w-full h-20 flex flex-col space-y-2 bg-yellow-100 text-yellow-700 hover:bg-yellow-200">
						...
						<Link href="/admin/settings">
							<Button className="w-full h-20 flex flex-col space-y-2 bg-red-100 text-red-700 hover:bg-red-200">
